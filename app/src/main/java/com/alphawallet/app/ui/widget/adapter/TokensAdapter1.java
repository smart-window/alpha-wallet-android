...
import com.alphawallet.app.ui.widget.holder.TokenHolder1;
...
public class TokensAdapter1 extends RecyclerView.Adapter<BinderViewHolder> {
    ...
    public TokensAdapter1(OnTokenClickListener onTokenClickListener, AssetDefinitionService aService, TokensService tService,
    ...
    protected TokensAdapter1(OnTokenClickListener onTokenClickListener, AssetDefinitionService aService) {
        this.onTokenClickListener = onTokenClickListener;
        this.assetService = aService;
    ...
    public BinderViewHolder<?> onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TokenHolder1.VIEW_TYPE: {
                TokenHolder1 tokenHolder = new TokenHolder1(parent, assetService, tokensService, realm);
    ...
    public void updateToken(TokenCardMeta token, boolean notify)
    {
        if (canDisplayToken(token))
        {
            ...
            {
                TokenSortedItem tsi = new TokenSortedItem(TokenHolder1.VIEW_TYPE, token, token.nameWeight);
