...
public class TokenHolder1 extends BinderViewHolder<TokenCardMeta> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public TokenHolder1(ViewGroup parent, AssetDefinitionService assetService, TokensService tSvs, Realm r)
    {
        super(R.layout.item_token1, parent);
    ...
    public void bind(@Nullable TokenCardMeta data, @NonNull Bundle addition)
    {
        try
        {
            ...
            tokenLayout.setBackgroundResource(R.drawable.background_blue_white);//background_marketplace_event
