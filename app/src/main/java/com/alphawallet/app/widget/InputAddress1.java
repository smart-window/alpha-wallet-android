...
import com.alphawallet.app.ui.widget.entity.ENSHandler1;
 ...
 */
public class InputAddress1 extends RelativeLayout implements ItemClickListener, ENSCallback, TextWatcher
{
    ...
    private final ENSHandler1 ensHandler;
    ...
    public InputAddress1(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        inflate(context, R.layout.item_input_address1, this);
        ...
        if (handleENS)
        {
            ...
            ensHandler = new ENSHandler1(this, adapterUrl);
        }
        else
        {
            ensHandler = null;
    ...
    private void setBoxColour(BoxStatus status)
    {
        switch (status)
        {
            case ERROR:
                ...
                break;
            case UNSELECTED:
                boxLayout.setBackgroundResource(R.drawable.background_password_entry_trans);
                //labelText.setTextColor(context.getColor(R.color.dove));
                errorText.setVisibility(View.GONE);
                break;
            case SELECTED:
                boxLayout.setBackgroundResource(R.drawable.background_blue_button);
