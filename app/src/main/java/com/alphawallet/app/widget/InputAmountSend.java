...
public class InputAmountSend extends LinearLayout
{
    ...
    public InputAmountSend(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        this.context = context;
        inflate(context, R.layout.item_input_amount_send, this);
    ...
    public void showError(boolean showError, int customError)
    {
        ...
        else
        {
            ...
            editText.setTextColor(context.getColor(R.color.blue));
        }
