 ...
 */
public class ChainNameBlue extends LinearLayout
{
    private final TextView chainName;
    private boolean invertNameColour;

    public ChainNameBlue(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        inflate(context, R.layout.item_chain_name_blue, this);
