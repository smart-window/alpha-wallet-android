...
public class InputView1 extends LinearLayout {
    ...
    public InputView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        inflate(context, R.layout.item_input_view1, this);
    ...
    private void setBoxColour(BoxStatus status)
    {
        switch (status)
        {
            ...
            case UNSELECTED:
               ...
               // labelText.setTextColor(context.getColor(R.color.silver));
                errorText.setVisibility(View.GONE);
                break;
            case SELECTED:
                boxLayout.setBackgroundResource(R.drawable.background_blue_button);
                //labelText.setTextColor(context.getColor(R.color.blue));
                errorText.setVisibility(View.GONE);
                break;
        }
    }
